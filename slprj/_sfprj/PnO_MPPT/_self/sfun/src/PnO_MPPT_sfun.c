  ...
  chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==1) {
    c1_PnO_MPPT_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3378707104U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3017667140U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2804323507U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1757547791U);
       ...
       case 1:
        {
          ...
          sf_c1_PnO_MPPT_get_check_sum(plhs);
          break;
        }
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1496537736U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(198497425U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1267969645U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1682464919U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "TM0lfdLPUZUhCIyULHHcpF") == 0) {
          extern mxArray *sf_c1_PnO_MPPT_get_autoinheritance_info(void);
          plhs[0] = sf_c1_PnO_MPPT_get_autoinheritance_info();
          break;
        }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        extern const mxArray *sf_c1_PnO_MPPT_get_eml_resolved_functions_info
          (void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c1_PnO_MPPT_get_eml_resolved_functions_info();
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "mgD2Zl2rZ5rwZLZK5jIGlC") == 0) {
          extern mxArray *sf_c1_PnO_MPPT_third_party_uses_info(void);
          plhs[0] = sf_c1_PnO_MPPT_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "mgD2Zl2rZ5rwZLZK5jIGlC") == 0) {
          extern mxArray *sf_c1_PnO_MPPT_updateBuildInfo_args_info(void);
          plhs[0] = sf_c1_PnO_MPPT_updateBuildInfo_args_info();
          break;
        }
      }
